...
Новая версия доступна на GitHub здесь:

https://github.com/Mineflat/AiaConviveBot
...
Идентификатор бота можно увидеть при запуске приложения, а ссылку для подключения к API - по команде `/get api`.
