...
> Отправить случайное изображение из указанной директории. Обратите внимание, что изображение так же может быть отправлено и из поддиректорий (рекурсивный поиск). **Поддерживаемые типы изображений**: `.jpg`, `.gif`, `.png` и `.jpeg`
